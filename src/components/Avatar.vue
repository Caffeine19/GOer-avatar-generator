...
<template>
  <svg viewBox="0 0 546 546" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="Avatar" :filter="`url(#${filterId})`">
      <g :clip-path="`url(#${clipPathId})`">
        <rect :fill="color?.backgroundColor || '#D2F4F0'" width="546" height="546" />
        <g id="Avatar">
          <g id="Shadow" opacity="0.2">
            <g id="Group 4">
              ...
              <ellipse
                ...
                rx="12.5277"
                ry="14.8672"
                transform="matrix(0.656007 0.754754 -0.89298 0.450096 439.37 167.529)"
                fill="#FFE0E0"
              />
            </g>
            <g id="Group 6">
              <path
                id="Ellipse 6_2"
                d="M107.742 189.119C117.729 208.104 139.529 219.244 155.924 215.308C172.319 211.371 178.825 193.437 168.838 174.451C158.851 155.465 137.051 144.326 120.656 148.262C104.26 152.198 97.7546 170.133 107.742 189.119Z"
                :fill="color?.primaryColor || '#61BCE2'"
                stroke="black"
                stroke-width="6.37119"
              />
              <ellipse
                ...
                rx="12.5277"
                ry="14.8672"
                transform="matrix(-0.972371 0.23344 0.465552 0.88502 147.075 164.999)"
                fill="#FFE0E0"
              />
            </g>
            <g id="Group 3">
              <path
                id="Vector 1"
                d="M97.6527 547.676V551.151H101.128H475.87H479.345V547.676V295.692C479.345 262.64 467.033 229.5 440.063 209.387C333.355 129.81 212.433 147.764 123.109 220.75C105.987 234.741 97.6527 256.222 97.6527 277.953V547.676Z"
                :fill="color?.primaryColor || '#61BCE2'"
                stroke="black"
              ...
              <path
                id="Vector 2"
                d="M186.27 547.742C186.27 413.658 381.46 385.856 389.859 547.742H186.27Z"
                fill="#FFE0E0"
              />
              <path
                id="Ellipse 1"
              ...
              <path
                id="Ellipse 2"
                d="M255.484 285.339C255.484 329.255 218.86 364.979 173.528 364.979C128.196 364.979 91.5712 329.255 91.5712 285.339C91.5712 241.423 128.196 205.699 173.528 205.699C218.86 205.699 255.484 241.423 255.484 285.339Z"
                fill="white"
                stroke="black"
                stroke-width="5.21279"
              />
              <g id="Group 1">
                <circle id="Ellipse 3" cx="137.907" cy="293.158" r="22.2992" fill="black" />
                <ellipse
                  id="Ellipse 4"
                  cx="132.404"
                  cy="288.235"
              ...
              <g id="Group 2">
                <circle id="Ellipse 3_2" cx="373.641" cy="288.524" r="22.2992" fill="black" />
                <ellipse
                  id="Ellipse 4_2"
                  cx="368.138"
                  cy="283.601"
          ...
          <g id="Body">
            <g id="RightEar">
              ...
              <ellipse
                ...
                rx="12.5277"
                ry="14.8672"
                transform="matrix(0.656007 0.754754 -0.89298 0.450096 424.311 167.529)"
            ...
            <g id="LeftEar">
              <path
                id="Ellipse 6_4"
                d="M92.6826 189.119C102.67 208.104 124.469 219.244 140.865 215.308C157.26 211.371 163.766 193.437 153.779 174.451C143.792 155.465 121.992 144.326 105.597 148.262C89.2012 152.198 82.6955 170.133 92.6826 189.119Z"
                :fill="color?.primaryColor || '#61BCE2'"
                stroke="black"
                stroke-width="6.37119"
              />
              <ellipse
                ...
                rx="12.5277"
                ry="14.8672"
                transform="matrix(-0.972371 0.23344 0.465552 0.88502 132.016 164.999)"
                :fill="color?.secondaryColor || '#90D0EB'"
              />
            </g>
            <g id="Main">
              <path
                id="Vector 1_2"
                d="M82.5937 534.973V538.449H86.0688H457.914H461.39V534.973V282.677C461.39 249.797 449.215 216.814 422.463 196.697C316.535 117.043 196.479 135.014 107.819 208.051C90.8389 222.039 82.5937 243.419 82.5937 265.038V534.973Z"
                :fill="color?.primaryColor || '#61BCE2'"
                stroke="black"
                stroke-width="6.95038"
              />
              ...
              <g id="LeftEye">
                <path
                  id="Ellipse 2_2"
                  d="M240.425 272.596C240.425 316.513 203.801 352.236 158.469 352.236C113.136 352.236 76.5119 316.513 76.5119 272.596C76.5119 228.68 113.136 192.957 158.469 192.957C203.801 192.957 240.425 228.68 240.425 272.596Z"
                  fill="white"
                  stroke="black"
                  stroke-width="5.21279"
                />
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur :stdDeviation="effect?.blur || 0" result="effect1_foregroundBlur_40_1189" />
      </filter>
      <clipPath :id="clipPathId">
        <rect x="11" y="11" width="524" height="524" :rx="radius || 0" fill="white" />
      </clipPath>
    </defs>
  </svg>
</template>
